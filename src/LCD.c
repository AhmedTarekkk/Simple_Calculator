...
void LCD_init(void)
{
	...
	GPIO_u8SetPinMode(LCD_u8_RS_PORT_ID, LCD_u8_RS_PIN_ID, GPIO_u8_OUTPUT_GP_PP);
	GPIO_u8SetPinMode(LCD_u8_E_PORT_ID, LCD_u8_E_PIN_ID, GPIO_u8_OUTPUT_GP_PP);
	...
	for(i = 0 ; i < 8 ; i++)
	{
		GPIO_u8SetPinMode(LCD_u8_DATA_PORT_ID, LCD_u8_PORT_START_PIN+i, GPIO_u8_OUTPUT_GP_PP);
	}
	LCD_sendCommand(LCD_TWO_LINES_EIGHT_BITS_MODE);

#elif(LCD_u8_DATA_BITS_MODE == 4)

	GPIO_u8SetPinMode(LCD_u8_DATA_PORT_ID, LCD_u8_DB4_PIN_ID, GPIO_u8_OUTPUT_GP_PP);
	GPIO_u8SetPinMode(LCD_u8_DATA_PORT_ID, LCD_u8_DB5_PIN_ID, GPIO_u8_OUTPUT_GP_PP);
	GPIO_u8SetPinMode(LCD_u8_DATA_PORT_ID, LCD_u8_DB6_PIN_ID, GPIO_u8_OUTPUT_GP_PP);
	GPIO_u8SetPinMode(LCD_u8_DATA_PORT_ID, LCD_u8_DB7_PIN_ID, GPIO_u8_OUTPUT_GP_PP);
