...
#define LCD_u8_E_PORT_ID				GPIO_u8_GPIOA
#define LCD_u8_E_PIN_ID					GPIO_u8_PIN9

#define LCD_u8_DATA_PORT_ID				GPIO_u8_GPIOA
#define LCD_u8_RCC_BUS					RCC_u8_GPIOA
...
#define LCD_u8_DB4_PIN_ID               GPIO_u8_PIN4
#define LCD_u8_DB5_PIN_ID               GPIO_u8_PIN5
#define LCD_u8_DB6_PIN_ID               GPIO_u8_PIN6
#define LCD_u8_DB7_PIN_ID               GPIO_u8_PIN7
