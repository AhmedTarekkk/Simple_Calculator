...
*                        			INPUT MODES 	  	                       *
*******************************************************************************/
/* The first two bits represent the mode */
/* The second two bits represent the configurations pull up / down / floating */
#define GPIO_u8_INPUT_ANALOG       			0b0011
#define GPIO_u8_INPUT_FLOATING     			0b0000
#define GPIO_u8_INPUT_PULL_DOWN    			0b1000
#define GPIO_u8_INPUT_PULL_UP      			0b0100
...
*******************************************************************************/
/* The first two bits represent the mode */
/* The last bit represent the configurations open drain / push pull */
#define GPIO_u8_OUTPUT_GP_PP      			0b001
#define GPIO_u8_OUTPUT_GP_OD      			0b101
#define GPIO_u8_OUTPUT_AF_PP      			0b010
#define GPIO_u8_OUTPUT_AF_OD      			0b110
